...
export default function AnalysisPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8 pb-20 bg-background min-h-screen transition-colors duration-300">
            {/* Nav & Header */}
            <div className="flex items-center justify-between mb-8 sticky top-0 z-50 bg-background/80 backdrop-blur-md p-4 rounded-b-2xl border-b border-border/50 shadow-sm">
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg font-bold text-sm hover:opacity-90 transition-opacity shadow-lg shadow-primary/20"
                    >
